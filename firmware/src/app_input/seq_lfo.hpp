#ifndef N1GP_APP_INPUT_SEQ_LFO_H
#define N1GP_APP_INPUT_SEQ_LFO_H

#include <app_input/base.hpp>

struct AppInputSeqLfo {
  inline void init() {
    app_screen.changeMode(AppScreenSeq {});
    seq.changeTrack(AppTrackType::lfo);
  }
  ...
  inline void refresh() {
    ...
    screen_mode.setTitle("SEQ:LFO", 16);
  }
};

#endif /* N1GP_APP_INPUT_SEQ_LFO_H */
